        ...
        <div className="grid gap-10 md:grid-cols-2">
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 bg-gradient-to-tr from-primary/10 via-transparent to-primary/5 transition-opacity duration-500 pointer-events-none" />
            </div>
          ))}
        </div>
      </div>
